...
class ao_snap_dialog(QtWidgets.QDialog):
    ...
    def contour_visibility(self):
        return self._dsp['contour_visibility']
    @property
    def contour_width(self):
        return self._dsp['contour_width']
    @property
    def contour_color(self):
        return self._dsp['contour_color']
    @property
        ...
        if self.contour_visibility:
            ...
            for i, contour in enumerate(self.contours):
                if self.srcgray[i]:
                    ...
                    poly = QtGui.QPolygon([QtCore.QPoint(int(x*sc), int(y*sc)) for x, y in contour])
